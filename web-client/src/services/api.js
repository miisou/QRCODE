...
const api = axios.create({
    baseURL: 'https://bebra-verifier.onrender.com/api/v1',
    headers: {
...
export const verifySession = async (token) => {
    ...
    // But maybe we want to poll status? The plan didn't specify polling.
    // The plan says "WC stops network activity".
